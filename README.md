...
Bonuses: 
- Lenght increase ![Screenshot]((Screenshots/increaseLenght.png?raw=true "Lenght increase bonus")
Increases player's panel lenght
- Multiply balls ![Screenshot]((Screenshots/multiplyBall.png?raw=true "Balls multiply")
Multiply count of all balls on screen by 2
- Speed up ![Screenshot]((Screenshots/multiplyBall.png?raw=true "Speed up")
